...
public class SongPlayer : MonoBehaviour
{
	...
	{
		Song = song;
		//Song.BGMData.GetBGMs(World.langIdx)
		Debug.Log("langIDx" + World.langIdx);
		if( World.langIdx == 0 )
		{
			Debug.Log ("SetSong bgm1");
			if( Song.BGMData.bgm1[1].clip != null )
				Song.BackgroundTrack = Song.BGMData.bgm1[1].clip;
		}
		else
		{
			Debug.Log ("SetSong bgm2");
			if( Song.BGMData.bgm2[1].clip != null )
				Song.BackgroundTrack = Song.BGMData.bgm2[1].clip;
		}
